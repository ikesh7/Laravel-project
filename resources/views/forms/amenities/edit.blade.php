            ...
            <div class="kt-portlet kt-portlet--mobile ">
                ...
                <div class="pb-12">
                    <div class="kt-portlet__body">
                        ...
                        <form method="POST" action="{{ route('amenity.update',$amenity->id) }}" >
                            ...
                            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                                ...
                                <div class=" overflow-hidden layout_form">
                                    ...
                                    <div class="mt-4 price_amenity_update">
                                        <x-label for="name_en" :value="__(' Name :')" class="fill-current ml-1" />

                                        <x-input name="name_en" id="name_en" class="form-control" type="text" value="{{ $amenity->name_en }}" placeholder="Name" required />
                                    </div>
                                    <br>
                                    <div class="mt-4 desc_amenity">
                                        <x-label for="desciption_en" :value="__(' Description :')" class="fill-current  ml-1" />

                                        <textarea name="desciption_en" class="form-control" rows="10">{{ $amenity->desciption_en }}
                                        </textarea>
                                    </div>

                                    <div class="mt-4 price_amenity_update">
                                        <x-label for="price" :value="__(' Price :')" class="fill-current  ml-1" />

                                        <x-input name="price" id="price" class="form-control" type="number" value="{{ $amenity->price }}" placeholder="Price (in Rs.)" required />
                                    </div>
                                    <br>
