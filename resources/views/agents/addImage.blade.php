                    ...
                    <div class="kt-portlet__body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                ...
                                <form
                                    action="{{ route('hotel.media.destroy',['mediaId'=>$image->id,'modelId' => $hotel->id]) }}"
                        ...
                        <form method="POST" action="{{ route('hotel.upload',$hotel->id) }}" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <a class="btn btn-sm btn-outline-danger"
                                                href="{{route('agent.index')}}">Cancel</a>
                                        </div>
                                    </div>
                                </div>
                        </form>
