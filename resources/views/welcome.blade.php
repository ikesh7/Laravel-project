...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body class="antialiased">
        <div class="relative flex items-top justify-center min-h-screen overflow-hidden layout_form">
            ...
            <div class="container">
                <div class="col-md-12">
                    <h3 class="mb-4 font-weight-bold">Search Hotel</h3>
                    <div class="form-group">
                        <div class="col-md-12 pl-0 pr-0">
                            <x-input type="text" name="city_name" id="city_name" class="form-control form-control-lg p-4" placeholder="Search City" />
            ...
            <!-- <div class="">
                <h3>Search Hotel</h3><br />
   
                <div class="container">
                    <div class="form-group">
                        <div class="col-4">
                            <x-input type="text" name="city_name" id="city_name" class="form-control input-lg" placeholder="Search City" />
                            <x-input id="name" class="lastname" type="text" name="last_name" :value="old('name')" placeholder="Last name" required autofocus /> -->
                            <!-- <div id="cityList">
                            </div>
                        </div>
